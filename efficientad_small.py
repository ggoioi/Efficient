...
def get_argparse():
    ...
    parser.add_argument('-o', '--output_dir', default='./output/small_v1_11_06',
...
def main():
    ...
    if pretrain_penalty:
        ...
        penalty_loader = DataLoader(penalty_set, batch_size=8, shuffle=True,
                                    num_workers=4, pin_memory=True)
    ...
    print(teacher_mean, teacher_std)
    ...
    for i in range(len(y_score)):
        if y_score[i] >=0.156954:
            y_pred.append(1)
        else:
            y_pred.append(0)
    print('Predict Label : ',y_pred)
    print('q관련 st_start, st_end, ae_start, ae_end 순서 ', q_st_start, q_st_end, q_ae_start, q_ae_end)
