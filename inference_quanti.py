...
path = './model_save'  # 저장된 모델 불러오는 코드
auto = torch.load( path+ '/autoencoder_quantized.pth')
stu = torch.load(path + '/student_quantized.pth')
tea = torch.load(path + '/teacher_quantized.pth')
